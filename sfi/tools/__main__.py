...
server = subcmd.add_parser("serve-index", help="Start up the index http server", formatter_class=Fmt)
...
client = subcmd.add_parser("query-index", help="Queries the index server for nearest neighbours", formatter_class=Fmt)
...
train = subcmd.add_parser("model-train", help="Trains a classification model with a resnet50 backbone", formatter_class=Fmt)
...
infer = subcmd.add_parser("model-infer", help="Runs inference with a classification model", formatter_class=Fmt)
...
export = subcmd.add_parser("model-export", help="Export a classification model to onnx", formatter_class=Fmt)
